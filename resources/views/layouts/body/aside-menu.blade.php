    ...
    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
        ...
        <ul class="kt-menu__nav ">
            ...
            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="/var" class="kt-menu__link kt-menu__toggle">
                    <span class="kt-menu__link-icon">
                        <i class="flaticon2-new-email"></i>
                    </span>
                    <span class="kt-menu__link-text">VAR</span>
                </a>
            </li>
            ...
            {{-- <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="/usuarios" class="kt-menu__link kt-menu__toggle">
                    <span class="kt-menu__link-icon">
            ...
            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="/turmas" class="kt-menu__link kt-menu__toggle">
                    <span class="kt-menu__link-icon">
