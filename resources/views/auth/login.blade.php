					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							...
							<div class="kt-login__signin">
								...
								<div class="alert alert-danger m--hide" hidden="true" role="alert">
									<div class="alert-text">Sua senha está incorreta. Confira-a.</div>
								</div>
                                <form method="POST" id="save_form" class="kt-form" action="{{ route('login') }}">
                                        @csrf
									<div class="input-group">
                                        {{-- <input class="form-control" type="text" placeholder="Email" name="email" autocomplete="off"> --}}
                                        <input class="form-control" id="email" placeholder="Email" type="email" class="form-control" name="email" value="{{ old('email') }}" autocomplete="email" autofocus>
									</div>
									<div class="input-group">
                                        {{-- <input class="form-control" type="password" placeholder="Password" name="password"> --}}
                                        <input placeholder="Senha" class="form-control" id="password" type="password" class="form-control" name="password" autocomplete="current-password">
									</div>
									...
									<div class="kt-login__actions">
										<button id="kt_login_signin_submit" type="submit" class="btn btn-brand btn-elevate kt-login__btn-primary">Fazer Login</button>
									</div>
								</form>
							</div>
							<div class="kt-login__signup">
                                <form method="POST" class="kt-form" action="{{ route('register') }}">
									...
									<div class="kt-login__actions">
										<button id="kt_login_signup_submit" type="submit" class="btn btn-brand btn-elevate kt-login__btn-primary">Cadastrar</button>&nbsp;&nbsp;
							...
							<div class="kt-login__account">
								...
								&nbsp;&nbsp;
								<a href="javascript:;" id="kt_login_signup" class="kt-login__account-link">Crie sua conta!</a>
							</div>
						</div>
					</div>
				</div>
