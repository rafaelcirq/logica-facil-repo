					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							...
							<div class="kt-login__signin">
								<div class="kt-login__head" style="margin-top: -8%; margin-bottom: -2%;">
                                ...
                                <form method="POST" class="kt-form" action="{{ route('login') }}">
									...
									<div class="input-group">
                                        ...
                                        <input placeholder="Senha" class="form-control" id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
									</div>
