...
<script src="{{ asset('js/var/compilador.js') }}"></script>
@endsection
...
<ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#kt_tabs_5_1" role="tab">Instruções</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#kt_tabs_5_2" role="tab">Var</a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" data-toggle="tab" href="#kt_tabs_5_3" role="tab">Compilador</a>
    </li>
</ul>
